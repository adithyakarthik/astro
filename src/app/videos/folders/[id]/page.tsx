    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:bg-zinc-900 dark:border-zinc-800">
        ...
        {eligibleClients.length === 0 ? (
          <p className="mt-4 text-sm text-zinc-400 dark:text-zinc-500">{t("videos.noEligibleClients")}</p>
        ) : (
          <ActionForm action={updateThisFolderAccess} className="mt-4 flex flex-col gap-2">
            ...
            <button
              type="submit"
              className="mt-2 w-fit rounded-lg bg-amber-600 px-4 py-2 text-sm font-medium text-white hover:bg-amber-700"
            >
              {t("videos.saveAccess")}
            </button>
          </ActionForm>
