    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-6 dark:bg-zinc-950">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{t("login.signInSubtitle")}</p>
        </div>
        ...
        <form action={requestOtp} className="flex flex-col gap-4 rounded-xl border border-zinc-200 bg-white p-6 dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <p className="mt-4 text-center text-xs text-zinc-400 dark:text-zinc-500">{t("login.footerNote")}</p>
      </div>
    </div>
  );
}
